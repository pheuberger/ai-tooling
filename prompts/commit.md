...
Steps:
1. Run: git add -A && git reset HEAD -- .ralph-logs .vima
...
3. Write a commit message that focuses on the *why* more than the *what*.
   ...
   Include "(${TICKET_ID})" on its own line at the bottom of the commit body.
...
6. Do NOT run vima commands. Do NOT push.
